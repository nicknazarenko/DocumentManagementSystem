...
<div class="row">
	...
	<div class="col-md-3">
		<div class="form_group">
			<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('Program');?></label>
...
<div id="student_entry">
	<div class="row" style="margin-bottom:10px;">
		...
		<div class="form-group">
			<input type="text" name="roll[]" id="roll" class="form-control" style="width: 160px; margin-left: 5px;"
				placeholder="<?php echo get_phrase('Registration Number');?>" required>
		</div>


		<div class="form-group">
						<select name="year[]" id="" class="form-control" style="width: 110px; margin-left: 5px;">
		...
		<div class="form-group">
			<input type="text" name="address[]" id="address" class="form-control" style="width: 160px; margin-left: 5px;"
