        ...
        ?>
            <li>
                <a href="#<?php echo $row['section_id'];?>" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo get_phrase('Unit');?> <?php echo $row['name'];?> ( <?php echo $row['nick_name'];?> )</span>
                </a>
            </li>
        <?php endforeach;?>
        <?php endif;?>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            <th width="150"><div><?php echo get_phrase('Registration No.');?></div></th>
                            
                            <th width="80"><div><?php echo get_phrase('photo');?></div></th>
                            <th><div><?php echo get_phrase('name');?></div></th>
                            <th width="150"><div><?php echo get_phrase('year');?></div></th>
                            <th width="150"><div><?php echo get_phrase('phone');?></div></th>
