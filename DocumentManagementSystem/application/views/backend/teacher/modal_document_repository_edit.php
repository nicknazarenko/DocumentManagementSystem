...
$single_study_material_info = $this->db->get_where('repository', array('document_id' => $param2))->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?teacher/document_repository/update/<?php echo $row['document_id'] ?>" method="post" enctype="multipart/form-data">
