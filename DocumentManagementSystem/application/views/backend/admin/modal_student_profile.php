		...
		<div class="row">
			...
			<div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <?php if($row['class_id'] != ''):?>
                    <tr>
                        <td><?php echo get_phrase('Program');?></td>
                    ...
                    <?php if($row['roll'] != ''):?>
                    <tr>
                        <td><?php echo get_phrase('Registration No.');?></td>
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->year;?></b></td>
                    </tr>
                    <tr>
